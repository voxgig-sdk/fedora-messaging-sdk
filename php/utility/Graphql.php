...
// FedoraMessaging SDK utility: graphql
//
...
class FedoraMessagingGraphql
{
    ...
    // equivalent.
    public static function body(FedoraMessagingContext $ctx): mixed
    {
    ...
    public static function errors(FedoraMessagingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
