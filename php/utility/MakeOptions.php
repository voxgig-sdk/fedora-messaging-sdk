...
// FedoraMessaging SDK utility: make_options

class FedoraMessagingMakeOptions
{
    ...
    public static function call(FedoraMessagingContext $ctx): array
    {
        ...
        //
        // `FedoraMessagingSchema::optspec()` is built from the model:
        ...
        $optspec = FedoraMessagingSchema::optspec();
