...
// FedoraMessaging SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FedoraMessagingMakeRequest
{
    public static function call(FedoraMessagingContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FedoraMessagingResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FedoraMessagingResponse($fetched);
        } else {
