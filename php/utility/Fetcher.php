...
class FedoraMessagingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FedoraMessagingSDK/1.0)';
    ...
    public static function call(FedoraMessagingContext $ctx, string $fullurl, array $fetchdef): array
    {
