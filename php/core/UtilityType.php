...
// FedoraMessaging SDK utility type

class FedoraMessagingUtility
{
    ...
    public static function copy(FedoraMessagingUtility $src): FedoraMessagingUtility
    {
        $u = new FedoraMessagingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
