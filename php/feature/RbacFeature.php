...
// FedoraMessaging SDK rbac feature
...
class FedoraMessagingRbacFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _required(FedoraMessagingContext $ctx): ?string
    {
    ...
    private function _reject(FedoraMessagingContext $ctx, string $required): void
    {
    ...
    private function _track(FedoraMessagingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
