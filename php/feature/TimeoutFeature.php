...
// FedoraMessaging SDK timeout feature
...
class FedoraMessagingTimeoutFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _with_timeout(FedoraMessagingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FedoraMessagingContext $_ctx, float $ms): void
    {
        $client = $this->client;
