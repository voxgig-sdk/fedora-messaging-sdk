...
// FedoraMessaging SDK telemetry feature
...
class FedoraMessagingTelemetryFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _close(FedoraMessagingContext $ctx, bool $ok): void
    {
