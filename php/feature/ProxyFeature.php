...
// FedoraMessaging SDK proxy feature
...
class FedoraMessagingProxyFeature extends FedoraMessagingBaseFeature
{
    ...
    public function init(FedoraMessagingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FedoraMessagingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
