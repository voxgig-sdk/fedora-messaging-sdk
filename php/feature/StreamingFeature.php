...
// FedoraMessaging SDK streaming feature
...
class FedoraMessagingStreamingFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _iterate(FedoraMessagingResult $result): \Generator
    {
    ...
    private function _streamable(FedoraMessagingContext $ctx): bool
    {
