...
// FedoraMessaging SDK audit feature
...
class FedoraMessagingAuditFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _emit(FedoraMessagingContext $ctx, string $outcome): void
    {
