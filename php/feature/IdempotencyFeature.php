...
// FedoraMessaging SDK idempotency feature
...
class FedoraMessagingIdempotencyFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _mutating(FedoraMessagingContext $ctx): bool
    {
