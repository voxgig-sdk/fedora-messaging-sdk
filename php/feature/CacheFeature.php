...
// FedoraMessaging SDK cache feature
...
class FedoraMessagingCacheFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _through(FedoraMessagingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
