...
// FedoraMessaging SDK clienttrack feature
...
class FedoraMessagingClienttrackFeature extends FedoraMessagingBaseFeature
{
    ...
    public function PostConstruct(FedoraMessagingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FedoraMessaging-SDK';
