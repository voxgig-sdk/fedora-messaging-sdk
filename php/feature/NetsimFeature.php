...
// FedoraMessaging SDK netsim feature
...
class FedoraMessagingNetsimFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _simulate(FedoraMessagingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FedoraMessagingContext $ctx, array $applied): void
    {
        $client = $this->client;
