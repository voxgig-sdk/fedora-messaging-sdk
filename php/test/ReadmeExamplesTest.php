...
// FedoraMessaging SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FedoraMessagingSDK::test)
...
{
    private const SDK_CLASS = 'FedoraMessagingSDK';
    ...
    private const SDK_BASE = 'fedoramessaging_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../fedoramessaging_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
