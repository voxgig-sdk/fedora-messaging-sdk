...
// FedoraMessaging SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FedoraMessagingOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FedoraMessagingOmni::structfix($now, Struct::undef()))
                        !== json_encode(FedoraMessagingOmni::structfix($val, Struct::undef()))) {
