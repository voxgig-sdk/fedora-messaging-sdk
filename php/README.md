# FedoraMessaging PHP SDK



The PHP SDK for the FedoraMessaging API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $search));
```
...
```
php/
├── fedoramessaging_sdk.php          -- Main SDK class
...
The main class (`fedoramessaging_sdk.php`) exports the SDK class
