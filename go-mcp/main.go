// Command FedoraMessaging-mcp is an MCP server exposing the FedoraMessaging
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FedoraMessaging_list  — list records of an entity
//	FedoraMessaging_load  — load a single record of an entity
//
