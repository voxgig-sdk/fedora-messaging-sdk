...
func registerTools(server *mcp.Server, client *sdk.FedoraMessagingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fedora-messaging_list",
		Description: "List records from FedoraMessaging. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fedora-messaging_load",
		Description: "Load a single record from FedoraMessaging. " +
...
func runOp(client *sdk.FedoraMessagingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FedoraMessagingSDK, name string) (sdk.FedoraMessagingEntity, error) {
