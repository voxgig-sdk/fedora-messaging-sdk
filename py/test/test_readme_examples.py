# FedoraMessaging SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FedoraMessagingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FedoraMessagingSDK(...) and FedoraMessagingSDK.test(...) become
#      FedoraMessagingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fedoramessaging_sdk"
_SDK_CLASS = "FedoraMessagingSDK"
