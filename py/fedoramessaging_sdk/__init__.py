...
from fedoramessaging_sdk.utility import register

# Load features
from fedoramessaging_sdk.feature.base_feature import FedoraMessagingBaseFeature
from fedoramessaging_sdk.features import _has_feature, _make_feature
...
class FedoraMessagingSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FedoraMessagingUtility()
        self._utility = utility

        from fedoramessaging_sdk.config import shared_config
    ...
    def get_utility(self):
        return FedoraMessagingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FedoraMessagingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Search(self, data=None) -> "SearchEntity":
        ...
        from fedoramessaging_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FedoraMessagingSDK":
        if sdkopts is None:
            sdkopts = {}
