# FedoraMessaging TypeScript SDK



The TypeScript SDK for the FedoraMessaging API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Search()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `FedoraMessagingSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `FedoraMessagingSDK.test(testopts?, sdkopts?)` | `FedoraMessagingSDK` | Create a test-mode client. |
...
| `client` | `client(): FedoraMessagingSDK` | Return the parent SDK client. |
...
fedora-messaging/
├── src/
│   ├── FedoraMessagingSDK.ts        # Main SDK class
