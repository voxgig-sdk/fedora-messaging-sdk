...
function runner.env_override(m)
  local live = runner.getenv("FEDORA_MESSAGING_TEST_LIVE")
  local override = runner.getenv("FEDORA_MESSAGING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FEDORA_MESSAGING_TEST_EXPLAIN")
