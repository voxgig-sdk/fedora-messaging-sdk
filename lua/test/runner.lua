...
function runner.env_override(m)
  local live = runner.getenv("FEDORAMESSAGING_TEST_LIVE")
  local override = runner.getenv("FEDORAMESSAGING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FEDORAMESSAGING_TEST_EXPLAIN")
