...
// FedoraMessaging SDK utility: result_basic

class FedoraMessagingResultBasic
{
    public static function call(FedoraMessagingContext $ctx): ?FedoraMessagingResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof FedoraMessagingError) ? $result->err->msg : (string)$result->err;
