...
// FedoraMessaging SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FedoraMessagingTransformResponse
{
    public static function call(FedoraMessagingContext $ctx): mixed
    {
        ...
        $transform = FedoraMessagingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
