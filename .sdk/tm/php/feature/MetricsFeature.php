...
// FedoraMessaging SDK metrics feature
...
class FedoraMessagingMetricsFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _record(FedoraMessagingContext $ctx, bool $ok): void
    {
