...
// FedoraMessaging SDK ratelimit feature
...
class FedoraMessagingRatelimitFeature extends FedoraMessagingBaseFeature
{
    ...
    private function _acquire(FedoraMessagingContext $ctx): void
    {
    ...
    private function _track(FedoraMessagingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
