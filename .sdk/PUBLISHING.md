...
|---|---|---|
| `ts/` | @voxgig-sdk/fedora-messaging-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/fedora-messaging-sdk \
      --repository voxgig-sdk/fedora-messaging-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/fedora-messaging-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/fedora-messaging-sdk --id=<id>` removes one.
