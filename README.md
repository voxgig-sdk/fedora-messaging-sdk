...
Retrieve historical messages sent via Fedora Messaging using HTTP GET requests.

Learn more about Fedora Messaging API at [apps.fedoraproject.org/datagrepper](https://apps.fedoraproject.org/datagrepper/).

This is an unofficial SDK for the Fedora Messaging public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| Python | `voxgig-sdk-fedora-messaging-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/fedora-messaging-sdk/tags) |
| PHP | `voxgig-sdk/fedora-messaging-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/fedora-messaging-sdk/tags) |
| Golang | `github.com/voxgig-sdk/fedora-messaging-sdk/go` | `go get github.com/voxgig-sdk/fedora-messaging-sdk/go@latest` |
| Ruby | `voxgig-sdk-fedora-messaging-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/fedora-messaging-sdk/tags) |
| Lua | `voxgig-sdk-fedora-messaging-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/fedora-messaging-sdk/tags) |
...
$searchs = $client->Search()->list();
print_r(array_map(fn($item) => $item->data_get(), $searchs));
```
...
- Upstream API: [https://apps.fedoraproject.org/datagrepper/](https://apps.fedoraproject.org/datagrepper/)
