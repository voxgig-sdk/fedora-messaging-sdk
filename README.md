...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/fedora-messaging` | `npm install @voxgig-sdk/fedora-messaging` |
| Python | `voxgig-sdk-fedora-messaging` | `pip install voxgig-sdk-fedora-messaging` |
| PHP | `voxgig-sdk/fedora-messaging` | `composer require voxgig-sdk/fedora-messaging` |
| Golang | `github.com/voxgig-sdk/fedora-messaging-sdk/go` | `go get github.com/voxgig-sdk/fedora-messaging-sdk/go` |
| Ruby | `voxgig-sdk-fedora-messaging` | `gem install voxgig-sdk-fedora-messaging` |
| Lua | `voxgig-sdk-fedora-messaging` | `luarocks install voxgig-sdk-fedora-messaging` |
