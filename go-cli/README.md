...
AQL-driven CLI and REPL for the FedoraMessaging SDK. Positional arguments are
...
```sh
go build -o fedora-messaging-cli ./...
```
...
./fedora-messaging-cli load 1 search
./fedora-messaging-cli load '{id:1}' search
