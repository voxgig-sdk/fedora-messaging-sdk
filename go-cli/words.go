...
func registerSDKWords(r *eng.Registry, client *sdk.FedoraMessagingSDK) {
...
func runOp(client *sdk.FedoraMessagingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
