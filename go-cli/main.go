// Command FedoraMessaging-cli is a CLI + REPL for the FedoraMessaging SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      FEDORA_MESSAGING_APIKEY (api key), FEDORA_MESSAGING_BASE (base url override)")
