...
type FedoraMessagingSDK struct {
	Mode     string
...
func (sdk *FedoraMessagingSDK) OptionsMap() map[string]any {
...
func (sdk *FedoraMessagingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FedoraMessagingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FedoraMessagingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FedoraMessagingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FedoraMessagingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FedoraMessagingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FedoraMessagingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FedoraMessagingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FedoraMessagingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FedoraMessagingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FedoraMessagingSDK {
	...
	sdk := NewFedoraMessagingSDK(sdkopts)
	sdk.Mode = "test"
