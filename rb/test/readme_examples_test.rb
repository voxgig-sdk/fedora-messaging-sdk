...
#      offline in seeded test mode (FedoraMessagingSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "FedoraMessaging_sdk.rb")
  SDK_CLASS = "FedoraMessagingSDK"
